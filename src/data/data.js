const data = [
  // B.TECH
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Students who have completed the 12th grade with physics, chemistry, and mathematics/biology with a minimum of 45% marks in case of general category.",
    },
    affiliation: {
    ...
    labs: [
      {
        ...
        description:
          "Explore networking concepts and protocols in a hands-on environment.",
        image: "../Courses/BTech/cse/lab/networking.jpg",
      },
      {
        title: "Database Management Lab",
        description:
          "Practice database design, implementation, and management techniques.",
        image: "../Courses/BTech/cse/lab/database.jpg",
      },
      {
        title: "Software Development Lab",
        description:
          "Develop and test software applications using industry-standard tools and methodologies.",
  ...
  
  {
    ...
    program_name:
      "B.Tech Electronics & Communication Engineering  (B.Tech ECE)",
    program_description:
    ...
    eligibility_criteria: {
      eligibility:
        "Students who have completed the 12th grade with physics, chemistry, and mathematics with a minimum of 45% marks in case of general category.",
    },
    affiliation: {
      affiliated_to: "Affiliated To IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
    ...
    labs: [
      ...
      },
      {
        ...
        description:
          "Experiment with communication principles and technologies.",
        image: "../Courses/BTech/civil/lab/system.jpg",
      },
      {
        title: "Signal Processing Lab",
        description:
          "Analyze and process signals using software and hardware tools.",
  ...
  },
  {
    ...
    program_highlights: [
      ...
      "Entrepreneurship Support: On-campus incubator for entrepreneurial opportunities.",
      "Expert Learning: Renowned faculty and industry guest speakers.",
      "Master the Latest Technologies: In-demand skills in power systems, renewable energy, control systems, electronics, communication, and more.",
    ],
    labs: [
      {
        title: "Power Systems Lab",
        description:
          "Explore power systems concepts and applications in a hands-on environment.",
        image: "../Courses/BTech/ee/lab/Power.jpg",
      },
      {
        title: "Electronics Lab",
        description:
          "Practice electronic circuit design, analysis, and testing using industry-standard equipment.",
        image: "../Courses/BTech/ee/lab/Electronics.jpg",
      },
      {
        title: "Renewable Energy Lab",
        description:
          "Experiment with renewable energy sources and technologies such as solar, wind, and hydroelectric power.",
    ...
    labs: [
      {
        ...
        description:
          "Experiment with thermodynamic principles and study heat transfer phenomena.",
        image: "../Courses/BTech/me/lab/thermo.jpg",
      },
      {
        title: "Machine Design Lab",
        description:
          "Apply engineering design principles to create and analyze machine components.",
        image: "../Courses/BTech/me/lab/machine.jpg",
      },
      {
        title: "Robotics Lab",
        description:
          "Design and program robotic systems to perform various tasks and operations.",
    ...
    labs: [
      {
        ...
        description:
          "Experiment with structural analysis and design of buildings and bridges.",
        image: "../Courses/BTech/civil/lab/structural.jpg",
      },
      {
        title: "Geotechnical Engineering Lab",
        description:
          "Study soil properties and behavior to design foundations and earth structures.",
        image: "../Courses/BTech/civil/lab/geometrical.jpg",
      },
      {
        title: "Environmental Engineering Lab",
        description:
          "Analyze water and air quality, and design solutions for environmental protection.",
  ...
  // M.TECH
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must have a Bachelor's degree in Computer Science and Engineering or a related field with a minimum aggregate of 50% marks (45% for reserved categories) from a recognized university.",
    },
    affiliation: {
      affiliated_to: "Affiliated To IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
    ...
    mode_of_admission:
      "Admission is typically based on entrance exams and/or academic performance. Candidates must apply through the designated admission portal.",
    program_highlights: [
  ...
  },
  {
    ...
    program_name:
      "M.Tech in Electronics & Communication Engineering (M.Tech ECE)",
    program_description:
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates who have passed B.E/B.Tech with at least 50% (45% in case of reserved category) marks in aggregate and valid GATE Score shall be eligible to apply for M.Tech Course. Admission for 85% Seats for residents of Punjab and 15% seats for outsiders shall be made strictly on the basis of valid GATE score.",
    },
    affiliation: {
      affiliated_to: "Affiliated To IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
    ...
    labs: [
      {
        ...
        description:
          "Experiment with digital signal processing techniques and algorithms.",
        image: "../Courses/BTech/ece/lab/signal.jpg",
      },
      {
        title: "Microelectronics Lab",
        description:
          "Design and fabricate microelectronic devices and circuits.",
        image: "../Courses/BTech/ece/lab/process.jpg",
      },
      {
        title: "VLSI Design Lab",
        description:
          "Design and simulate Very Large Scale Integration (VLSI) circuits.",
        image: "../Courses/BTech/ece/lab/electron.jpg",
      },
    ],
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must have a Bachelor's degree in Civil Engineering or a related field with at least 50% marks (45% for reserved category) in aggregate from a recognized university.",
    },
    affiliation: {
      affiliated_to: "Affiliated To IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
    ...
    labs: [
      {
        title: "Structural Engineering Lab",
        description:
          "Experiment with structural elements and systems to understand their behavior and performance.",
        image: "../Courses/BTech/civil/lab/structural.jpg",
      },
      {
        title: "Geotechnical Engineering Lab",
        description:
          "Study soil properties and behavior to assess the stability and bearing capacity of foundations.",
        image: "../Courses/BTech/civil/lab/geometrical.jpg",
      },
      {
        title: "Transportation Engineering Lab",
        description:
          "Analyze traffic flow, design road networks, and evaluate transportation systems.",
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Students who have completed a B.Tech degree in Mechanical Engineering or a related field with a minimum of 60% marks or equivalent CGPA.",
    },
    affiliation: {
      affiliated_to: "Affiliated To IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
    ...
    labs: [
      {
        title: "Thermodynamics Lab",
        description:
          "Experiment with advanced thermodynamic principles and study heat transfer phenomena.",
        image: "../Courses/BTech/me/lab/thermo.jpg",
      },
      {
        title: "Machine Design Lab",
        description:
          "Apply advanced engineering design principles to create and analyze complex machine components.",
        image: "../Courses/BTech/me/lab/machine.jpg",
      },
      {
        title: "Robotics Lab",
        description:
          "Design and program advanced robotic systems to perform various tasks and operations.",
        image: "../Courses/BTech/me/lab/robotics.jpg",
      },
    ],
  },
...

  {
    ...
    eligibility_criteria: {
      eligibility:
        "To be eligible for the B.H.M.C.T. program, candidates must meet the following criteria: Completion of 10+2 from a recognized board. Minimum aggregate marks of 45%. English as a mandatory subject. The age limit is up to 22 years.",
    },
    affiliation: {
    ...
    labs: [
      {
        ...
        description:
          "Practice culinary skills and techniques in a simulated kitchen environment.",
        image: "../Courses/HM/catering/lab/kitchen.jpg",
      },
      {
        title: "Bakery",
        description:
          "Learn to bake a variety of breads, pastries, and desserts.",
        image: "../Courses/HM/catering/lab/bakery.jpg",
      },
      {
        title: "Front Office Labs",
        description:
          "Gain practical experience in hotel front office operations, including check-in, check-out, and guest services.",
        image: "../Courses/HM/catering/lab/office.jpg",
      },
      {
        title: "Training Restaurant",
        description:
          "Practice food and beverage service in a restaurant setting.",
    ...
    labs: [
      {
        ...
        description:
          "Practice managing various aspects of hospitality operations in a simulated hotel environment.",
        image: "../Courses/HM/mhmct/lab/management.jpg",
      },
      {
        title: "Culinary Arts Lab",
        description:
          "Learn culinary techniques and practice cooking skills in a professional kitchen setting.",
        image: "../Courses/HM/mhmct/lab/arts.jpg",
      },
      {
        title: "Event Planning Lab",
        description:
          "Plan and organize events such as conferences, weddings, and banquets in a simulated setting.",
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates who have completed 10+2 examination with Science (Medical / Non-Medical) or its equivalent examination in any stream conducted by a recognized Board / University / Council.",
    },
    affiliation: {
      affiliated_to: "Affiliated To IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
    ...
    labs: [
      {
        ...
        description:
          "Learn techniques for assessing dietary intake, body composition, and nutritional status of individuals.",
        image: "../Courses/HM/Bsc/lab/nutrition.jpg",
      },
      {
        title: "Food Science Lab",
        description:
          "Explore the properties of food ingredients, food processing techniques, and food preservation methods.",
        image: "../Courses/HM/Bsc/lab/science.jpg",
      },
      {
        title: "Community Nutrition Lab",
        description:
          "Gain practical experience in planning and implementing community-based nutrition programs and interventions.",
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Passing of bachelor's degree in any stream from a University recognized by UGC",
    },
    affiliation: {
      affiliated_to: "Affiliated To IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
    ...
    labs: [
      {
        title: "Hospitality Management Lab",
        description:
          "Gain hands-on experience in managing various aspects of hospitality operations.",
        image: "../Courses/HM/mhmct/lab/management.jpg",
      },
      {
        title: "Culinary Arts Lab",
        description:
          "Practice culinary skills and techniques in a professional kitchen environment.",
        image: "../Courses/HM/mhmct/lab/arts.jpg",
      },
      {
        title: "Event Planning Lab",
        description:
          "Plan and organize events, conferences, and functions to develop event management skills.",
        image: "../Courses/HM/mhmct/lab/planning.jpg",
      },
    ],
  },
  ...
  },
  {
    ...
    major_tracks: ["Radiology Technician", "Imaging Specialist"],
    program_outcomes: [
      {
  ...
  },
  {
    ...
    fees: "45,000/- INR Per Semester",
    duration: "4 Years (Semester System)",
    major_tracks: ["Operation Theatre Technician", "Operation Theatre Manager"],
    program_outcomes: [
      {
  ...
  },
  {
    ...
    fees: "25,000/- INR Per Semester",
    duration: "4 Years (Semester System)",
    major_tracks: ["Laboratory Scientist", "Managerial Supervisor", "Teacher"],
    program_outcomes: [
      {
    ...
    eligibility_criteria: {
      eligibility:
        "Passing of 10+2 examination with Physics & Chemistry as compulsory subjects and either Mathematics or Biology as one of the subjects from recognized Board / University / Council. ",
    },
    affiliation: {
      affiliated_to: "Affiliated To IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
  ...
  },
  {
    ...
    fees: "45,000/- INR Per Semester",
    duration: "4 Years (Semester System)",
    major_tracks: ["Operation Theatre Assistant", "Anesthesia Technician"],
    program_outcomes: [
      {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must have passed 10+2 with Physics, Chemistry & Biology from a recognized Board / University / Council or 10+2 with vocational course in Medical Laboratory Science / Medical Laboratory Technology.",
    },
    affiliation: {
      affiliated_to: "Affiliated To MRSPTU, Bathinda",
      approved_by: "Approved by AICTE",
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must have passed 10+2 with Physics & Chemistry as compulsory subjects and either Mathematics or Biology from a recognized Board / University / Council or 10+2 with vocational course in Medical Laboratory Science / Medical Laboratory Technology.",
    },
    affiliation: {
      affiliated_to: "Affiliated To MRSPTU, Bathinda",
      approved_by: "Approved by AICTE",
  ...
  },
  {
    ...
    fees: "32,000/- INR Per Semester",
    duration: "2 Years (Semester System)",
    major_tracks: ["Emergency Anesthesia", "Operation Theatre Management"],
    program_outcomes: [
      {
  ...
  },
  {
    ...
    fees: "32,000/- INR Per Semester",
    duration: "2 Years (Semester System)",
    major_tracks: ["Clinical Research", "Diagnostic Sciences"],
    program_outcomes: [
      {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must have completed B.Sc. in Medical Laboratory Technology. Candidates who have passed B.Sc. in Medical, Life Sciences & Applied Life Sciences, Medicine, or Zoology can also apply.",
    },
    affiliation: {
      affiliated_to: "Affiliated To MRSPTU, Bathinda",
      approved_by: "Approved by AICTE",
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must have a B.Sc. in Medical Laboratory Science, Microbiology, or related field from a recognized University.",
    },
    affiliation: {
      affiliated_to: "Affiliated To  IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must have a B.Sc. in Radio Imaging Technology or a related field from a recognized University.",
    },
    affiliation: {
      affiliated_to: "Affiliated To  IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must have a B.Sc. in Cardiac Care Technology, Medical Laboratory Science, or a related field from a recognized University.",
    },
    affiliation: {
      affiliated_to: "Affiliated To MRSPTU, Bathinda",
      approved_by: "Approved by AICTE",
...

  {
    ...
    eligibility_criteria: {
      eligibility:
        "To be eligible for the BBA program, candidates must have completed their 10+2 or equivalent examination from a recognized board.",
    },
    mode_of_admission:
      "Admission is typically based on merit or entrance exams conducted by the institution. Candidates must apply through the designated admission portal.",
    program_highlights: [
...

  {
    ...
    eligibility_criteria: {
      eligibility:
        "To be eligible for the B.Com Honours program, candidates must have completed their 10+2 or equivalent examination from a recognized board.",
    },
    labs: [],
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must have completed B.Com with at least 50% marks and have the relevant subject as one of the subjects based on merit in qualifying exams.",
    },
    affiliation: {
      affiliated_to: "Affiliated To  IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
  ...
  // BASIC SCIENCES
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must have completed 10th and 12th in non-medical with at least 45% in Physics, Chemistry, and Math, or in medical with Math with at least 45%. For reserved category, minimum 40% in Physics, Chemistry, and Math, or in medical with Math with at least 40%.",
    },
    affiliation: {
      affiliated_to: "Affiliated To IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must hold a Bachelor's degree in Mathematics or a related field with at least 50% marks (45% for reserved categories) from a recognized institution.",
    },
    affiliation: {
      affiliated_to: "Affiliated To IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must have passed B.Sc. with Physics & Mathematics as compulsory subjects with at least 50% marks in aggregate in the qualifying examination.",
    },
    affiliation: {
      affiliated_to: "Affiliated To IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "All those candidates who have passed 10th and 12th in non med/med and B.sc with Chemistry with atleast 50% marks and for reserved category minimum 45%.",
    },
    affiliation: {
      affiliated_to: "Affiliated To MRSPTU, Bathinda",
      approved_by: "Approved by AICTE",
  ...
  // EDUCATION
  {
    ...
    eligibility_criteria: {
      eligibility:
        "The candidate must have pursued a Bachelor’s degree and/or a Master’s degree in Science/Humanities/Social Sciences/Commerce/Home Science/B.B.A/B.C.A/any equivalent degree. The candidate must have passed the qualifying degree examination with a minimum aggregate of 50% (45% for the reserved candidates).",
    },
    affiliation: {
    ...
    mode_of_admission:
      "For admissions, one has to appeared in Entrance conducted by university.  ",
    program_highlights: [
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "B.Ed with at least 50% aggregate (45% for the reserved candidates)",
    },
    affiliation: {
      affiliated_to: "Affiliated To Punjabi University, Patiala",
      approved_by: "NCTE",
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Pass in BA/ B.Sc/ B.Com/ BT/ B.Ed with a minimum of 50% aggregate (45% for the reserved candidates)",
    },
    affiliation: {
      affiliated_to: "Affiliated To IKGPTU, Jalandhar",
      approved_by: "Approved by AICTE",
  ...
  // DIPLOMA
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Candidates must have completed 10th grade or equivalent with a minimum passing percentage as per the admission guidelines.",
    },
    affiliation: {
  ...
  },
  {
    ...
    eligibility_criteria: {
      eligibility:
        "Admission to Diploma Level courses (except Diploma Course in Aircraft Maintenance Engineering) shall be made on the basis of merit of the subjects Math, Science, and English with overall status Pass in Matriculation examinations with a minimum of 45%, and for SC 40%. A gap certificate is required if the student has any gap after the last qualification, along with Migration.",
    },
    affiliation: {
      affiliated_to: "Affiliated To Approved by PSBTE & IT",
      approved_by: "Approved by AICTE",
  ...
  //Nursing
  {
    ...
    duration: "2 years",
    major_tracks: ["Patient Care", "Medical Procedures", "Healthcare Ethics"],
    program_outcomes: [
      {
    ...
    labs: [
      {
        ...
        description:
          "Gain hands-on experience in hospital settings under the guidance of experienced nursing professionals.",
        image: "../Courses/pharmacy/pharm/lab/researchLab.jpg",
      },
      {
        title: "Simulation Lab",
        description:
          "Practice nursing skills and scenarios using simulation technology for realistic training.",
        image: "../Courses/pharmacy/pharm/lab/practical.jpg",
      },
      {
        title: "Anatomy Lab",
        description:
          "Study human anatomy and physiology to understand the structure and function of the human body.",
        image: "../Courses/pharmacy/pharm/lab/QA.jpg",
      },
    ],
    eligibility_criteria: {
      eligibility:
        "Candidates must have completed their 10+2 examination from a recognized board with Science (PCB) stream.",
    },
    affiliation: {
      affiliated_to: "Affiliated To MRSPTU, Bathinda",
      approved_by: "Approved by AICTE",
  ...
  //ITI
  {
    ...
    header: {
      ...
      background_image:
        "https://utfs.io/f/1V3V2P4kpAumIiVpUpR21jqluvKkFoRaDpPfCGTtxewIs74z",
    },
    ...
    labs: [
      {
        ...
        description:
          "Hands-on training in welding techniques and equipment operation.",
        image:
          "https://utfs.io/f/1V3V2P4kpAumnhviqqA1z8WShHVuacLDIv5XR0itPqOklGMb",
      },
      {
        ...
        description:
          "Learn safety protocols and procedures for welding operations.",
        image:
          "https://utfs.io/f/1V3V2P4kpAuma3tIOwuqYuBgVRlAkHZebycN59qvW6rTdJwU",
      },
    ],
    eligibility_criteria: {
      eligibility:
        "Minimum educational qualification may vary depending on the institution. Typically, candidates must have completed at least 10th grade or equivalent.",
    },
    affiliation: {
    ...
    mode_of_admission:
      "Admission criteria may vary by institution. Interested candidates should contact the admission office for details.",
    program_highlights: [
  ...
  },
  {
    ...
    header: {
      ...
      background_image:
        "https://utfs.io/f/1V3V2P4kpAumbbhve9SVDWL2mqUCMHoirweBvNz5EsX03bOc",
    },
    ...
    program_outcomes: [
      {
        ...
        image:
          "https://utfs.io/f/1V3V2P4kpAumT1B7qD6itj04AFlILkGvbdQPE8uOqWpHYsUK",
      },
      {
      ...
      },
      {
        ...
        image:
          "https://utfs.io/f/1V3V2P4kpAumRcWurekmu2iQAmoaFD3d9eMskP7J6LXV4IRl",
      },
    ],
    labs: [
      {
        ...
        description:
          "Hands-on training in pipe installation and repair techniques.",
        image:
          "https://utfs.io/f/1V3V2P4kpAumT1B7qD6itj04AFlILkGvbdQPE8uOqWpHYsUK",
      },
      {
        title: "Safety Training",
        description:
          "Learn safety protocols and procedures for plumbing operations.",
        image:
          "https://utfs.io/f/1V3V2P4kpAumRcWurekmu2iQAmoaFD3d9eMskP7J6LXV4IRl",
      },
    ],
    ...
    program_outcomes: [
      {
        ...
        image:
          "https://utfs.io/f/1V3V2P4kpAum3uLmOOwG5iRg3yAkdO07cshDnUBISQJ9XTCe",
      },
      {
        title: "Data Entry Operator",
        desc: "Enter and update data in databases, spreadsheets, and other digital formats with accuracy and efficiency.",
        image:
          "https://utfs.io/f/nsz3ps3WUZRLQj2JOlHc7ILkp3Shaeo8Ds0FjqiG5UAfE41R",
      },
      {
        ...
        image:
          "https://utfs.io/f/nsz3ps3WUZRL7uOX80yZPFew0cpClJ4f9O3RUWHjaDvbq6AN",
      },
    ],
    labs: [
      {
        title: "Computer Lab",
        description:
          "Access to computers equipped with relevant software for practicing typing, data entry, and programming exercises.",
        image: "../Courses/BTech/cse/lab/networking.jpg",
      },
      {
        title: "Programming Workshop",
        description:
          "Hands-on sessions to learn programming languages and develop software applications.",
        image:
          "https://utfs.io/f/nsz3ps3WUZRL7uOX80yZPFew0cpClJ4f9O3RUWHjaDvbq6AN",
      },
    ],
