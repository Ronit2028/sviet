...
const Header = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("/api/sendEmail/admission7", {
        method: "POST",
        body: data,
      });
          ...
          <div className="w-10/12 mx-auto flex flex-wrap items-start justify-between">
            <div className="w-full md:w-1/2 py-12">
              ...
              <div className="flex gap-3 flex-wrap">
                <Link href="https://sviet.ac.in/admission-bihar7/">
            ...
            >
              ...
              <a
                href="https://wa.me/+919771043016" // Replace with your actual WhatsApp number
                target="_blank"
