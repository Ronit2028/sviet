        ...
        <div className="w-10/12 mx-auto flex flex-wrap items-start justify-between">
          <div className="w-full md:w-1/2 py-12">
            ...
            <p className="text-md lg:text-lg font-semibold mt-3 mb-3 pb-3">
              SVGOI, a beacon of academic distinction, proudly stands tall as it
              secures the honorable rank of 104 in NIRF 2021.
            </p>
          ...
          >
            ...
            <button
              type="submit"
              className="bg-[#fea700] text-white text-xl px-4 py-2 rounded-md"
            >
              Submit
            </button>
          </form>
