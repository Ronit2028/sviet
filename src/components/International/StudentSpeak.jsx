...
const testimonials = [
    {
        title:
        "As an international student at SVGOI, I found the faculty to be exceptionally supportive. The campus is vibrant, and the diverse student body made me feel at home. The facilities are top-notch, and I particularly enjoyed the cultural exchange programs.",
...
*2*
"SVGOI exceeded my expectations in every way. The curriculum is rigorous yet flexible, allowing me to explore my interests. The student services team was always ready to help with any issues, from academic to personal. I am proud to be part of this community."

*3*
"Studying at SVGOI has been an enriching experience. The professors are knowledgeable and approachable, and the practical learning approach helped me gain valuable skills. The campus life is engaging with numerous clubs and activities that cater to various interests."

*4*
"SVGOI offers a perfect blend of academic excellence and cultural diversity. The infrastructure is impressive, and the hands-on learning opportunities have prepared me well for my career. I appreciated the efforts of the international office in making my transition smooth."

*5*
"The learning environment at SVGOI is outstanding. The exposure to different teaching methodologies and the chance to work on real-world projects have been invaluable. The friendships I've formed and the support from the faculty have made my experience memorable."

*6*
"Choosing SVGOI was one of the best decisions I've made. The global perspective provided in the courses has broadened my understanding and opened up new career opportunities. The international student community here is strong and very welcoming."

*7*
"SVGOI has a wonderful community that embraces diversity. The academic programs are challenging but rewarding, and the support system for international students is excellent. The campus is safe and has everything you need for a comfortable stay."

*8*
"The holistic education approach at SVGOI is commendable. The balance between theoretical knowledge and practical application is well-maintained. The international student advisor was particularly helpful in guiding me through the initial phases of my stay."


"SVGOI has provided me with a comprehensive education that combines both practical and theoretical knowledge. The faculty's dedication to student success is truly commendable, always going the extra mile to ensure we understand the material. The campus itself is modern and well-equipped, providing a conducive environment for learning. I have also benefited greatly from the various workshops and seminars that are regularly organized. These have expanded my horizons and enhanced my academic experience."
