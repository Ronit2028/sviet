...
export default function Placement() {
  ...
  const students = [
    { name: "MOON MANDAL", logo: img2, package: "11 LPA", backgroundImage: img16 },
    { name: "SIMRAN KAUR", logo: img3, package: "10 LPA", backgroundImage: img22 },
    { name: "YASH KHANDELWAL", logo: img4, package: "16 LPA", backgroundImage: img19 },
    { name: "JYOTI CHAUBEY", logo: img32, package: "11 LPA", backgroundImage: img30 },
    { name: "SHAIENA PRIYA", logo: img10, package: "9 LPA", backgroundImage: img23 },
    { name: "SWATI KHANNA", logo: img7, package: "16 LPA", backgroundImage: img18 },
    { name: "ADITI RASHMI", logo: img33, package: "18 LPA", backgroundImage: img26 },
    { name: "AVINASH KUMAR", logo: img34, package: "15 LPA", backgroundImage: img25 },
    { name: "ROHAN SHUKLA", logo: img8, package: "18 LPA", backgroundImage: img20 },
    { name: "ASHISH KUMAR", logo: img11, package: "18 LPA", backgroundImage: img24 },
    { name: "ANKIT KUMAR", logo: img12, package: "27 LPA", backgroundImage: img28 },
    { name: "PAYAL KUMARI", logo: img13, package: "16 LPA", backgroundImage: img29 },
    { name: "GAURAV SAW", logo: img10, package: "11 LPA", backgroundImage: img31 },
    { name: "FARZAN ALAM", logo: img7, package: "14 LPA", backgroundImage: img27 },
    { name: "RITIK KUMAR", logo: img4, package: "14 LPA", backgroundImage: img21 },
    { name: "RITU KOUL", logo: img5, package: "13 LPA", backgroundImage: img17 },
  ];
    ...
    <div className="bg-zinc-50 pl-4">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex flex-wrap min-h-screen">
          ...
          {/* Alumni Section */}
          <div
            className="w-full lg:w-2/12 p-4 rounded-lg h-full flex flex-col justify-between lg:h-auto lg:mt-8 lg:mb-5 text-white"
            style={{
