...
const AboutUs = () => {
  return (
    ...
    <div className="gap-16   items-center py-8 px-5 mx-auto container md:w-4/5  lg:grid lg:grid-cols-2 lg:py-28 lg:px-6">
        ...
        <div className="flex md:mb-5 items-center md:justify-start justify-center">
                    <span className="md:border-l-2 border-[#ff9602] h-6 mr-3"></span>
                    <h1 className="text-sm md:text-lg font-bold">ABOUT</h1>
                </div>
                <h1 className="md:text-7xl text-4xl text-center md:text-start font-semibold mb-12  text-[#ff9602]">SVGOI </h1>
