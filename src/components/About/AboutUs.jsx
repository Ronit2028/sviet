...
const AboutUs = () => {
  return (
    ...
    <section class=" ">
    <div class="gap-16 items-center py-8 px-4 mx-auto container w-4/5 lg:grid lg:grid-cols-2 lg:py-36 lg:px-6">
        ...
        <div class="flex mb-5 items-center">
                ...
                <h1 class="text-7xl font-semibold mb-12  text-[#ff9602]">SVGOI </h1>
