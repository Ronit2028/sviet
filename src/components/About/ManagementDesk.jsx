...
<div  key={index} className="p-4  py-24 w-full">
<div className="h-full w-3/4 m-auto flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
  ...
  <div className="flex-grow sm:pl-8">
    ...
    <span className="inline-flex">
      ...
      >
        {desk.map((member, index) => (
          <div  key={index} className="p-4 w-full border-l-2 border-[#016db6]">
          <div className="h-full w-3/4 m-auto flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
