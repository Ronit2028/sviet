...
// import distinguishedImage from '@/assets/LandingPage/Chandigarh/distinguished.jpg'; // Replace with correct image path if needed

const FeatureSection16 = () => {
  return (
    <section className="lg:py-28 w-10/12 mx-auto py-10 px-8 bg-gray-100/50">
      <div className="container mx-auto mb-10  lg:mb-20">
        <Typography
          color="blue-gray"
          className="mb-2 font-bold uppercase border-l-2 border-[#fea700] pl-2"
        >
          Visited By
        </Typography>
        <Typography
          color="blue-gray"
          className="mb-4 !text-2xl font-bold lg:!text-4xl max-w-3xl"
        >
          The Distinguished: Leaders, <span className="text-[#fea700]">Visionaries</span>  and Changemakers
        </Typography>
        <Typography
          variant="lead"
          className=" !text-gray-500"
        >
          From business giants to education pioneers, our campus draws the best. 
          Each visit strengthens our legacy—fueling dreams, inspiring excellence, 
          and empowering every learner to lead with confidence.
        </Typography>
      </div>

      <div className="container mx-auto">
        <img
          src="https://bmnmsbiymz.ufs.sh/f/1V3V2P4kpAumAB8SXTMaBDdmCoRJZjItUX34hq2PyvkYHzVA"
          alt="Distinguished Visitors at Campus"
