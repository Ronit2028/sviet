...
const Card = ({ className, ...props }) => (
  ...
  {
    "company": "Office Order regarding Library Staff Weekend Duty",
    "date": "23-12-2025",
    "details": "This office order deputes specific library staff members for weekend duty to ensure smooth functioning of the Library in the Administration Block on Saturdays and Sundays from 09:00 AM to 04:40 PM. Duties will be performed on a rotation basis with immediate effect.",
