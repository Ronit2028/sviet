...
const GivingWings = () => {
    ...
    return (
        <div className='py-6 h-auto lg:h-[100vh] items-center'>
            <div className='w-10/12 mx-auto'>
                <div>
                    <p className="text-4xl text-center pt-6">
                        ...
                        <Slider {...settings}>
                            {collegeInformation.map((info, index) => (
                                <div key={index} className='p-3 h-full'>
                                    <div className="p-5 border rounded-md h-[40vh] flex flex-col justify-end bg-black text-white">
                ...
                <div className="flex flex-wrap py-6">
                    <div className="w-full md:w-1/2 bg-black text-white p-6 py-10 rounded-md flex flex-col justify-center">
                        ...
                        <Slider {...settings2}>
                            {placementDriveInformation.map((info, index) => (
                                <div key={index} className='px-2 h-full'>
                                    <div className="p-5 rounded-md flex flex-col h-[25vh] justify-between bg-gray-50">
                                        <div>
