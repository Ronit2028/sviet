            ...
            <div className='w-full md:w-1/2 bg-[#00112d] text-white grid grid-cols-1 md:grid-cols-2'>
                <div className='bg-[#fea700] h-[50vh] md:h-[auto]' style={{ backgroundImage: 'url(https://sviet.ac.in/wp-content/uploads/2024/02/Moon.png)', backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center center" }}>
                    <div className='flex items-end h-full w-full bg-gradient-to-t' style={{ background: 'linear-gradient(to top, rgba(0,0,0,1), rgba(0,0,0,0))' }}>
                        ...
                        <div className='w-1/3'>
                            <img src="https://sviet.ac.in/wp-content/uploads/2024/02/jio-white-removebg-preview.png" alt="" className='p-5' srcset="" width="100%"/>
                        </div>
                    </div>
                </div>
                <div className='bg-[#fea700] h-[50vh] md:h-[auto]' style={{ backgroundImage: 'url(https://sviet.ac.in/wp-content/uploads/2021/11/WhatsApp-Image-2021-11-02-at-12.21.29-AM-1.jpeg)', backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center center" }}>
                    <div className='flex items-end h-full w-full bg-gradient-to-t' style={{ background: 'linear-gradient(to top, rgba(0,0,0,1), rgba(0,0,0,0))' }}>
                        <div className='w-2/3 text-white flex flex-col justify-end p-5'>
                            <p className='text-3xl font-medium'>
                                Moon Mandal
                ...
                <div className='bg-[#fea700] h-[50vh] md:h-[auto]' style={{ backgroundImage: 'url(https://sviet.ac.in/wp-content/uploads/2023/12/Arjun-katoch-scaled-e1703863008510.jpg)', backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center center" }}>
                    <div className='flex items-end h-full w-full bg-gradient-to-t' style={{ background: 'linear-gradient(to top, rgba(0,0,0,1), rgba(0,0,0,0))' }}>
                        <div className='w-2/3 text-white flex flex-col justify-end p-5'>
                            <p className='text-3xl font-medium'>
                                Moon Mandal
