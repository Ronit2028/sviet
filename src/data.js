const data = [
    ...
    },
    {
        ...
        "header": {
            ...
            "subtitle": "MASTER THE MECHANICS OF INNOVATION",
            "background_image": "@/assets/Programs/backdrop.jpg"
        },
        "program_name": "M.Tech in Mechanical Engineering",
        "program_description": "Mechanical Engineering is a branch of engineering that focuses on the design, analysis, manufacturing, and maintenance of mechanical systems. It involves the application of principles from physics and materials science to create and improve machinery and devices that meet the needs of society. Mechanical engineers work in various industries, including automotive, aerospace, energy, manufacturing, and robotics. They are involved in designing and developing machines, engines, and tools, as well as optimizing their performance and efficiency. They also work on developing and implementing heating, ventilation, and air conditioning (HVAC) systems, as well as designing and analyzing structures and mechanisms. Mechanical engineers utilize computer-aided design (CAD) software, simulation tools, and other technologies to create virtual models and perform analysis before physically constructing prototypes. They also collaborate with other engineers and professionals to ensure the smooth integration of mechanical systems with electrical, electronic, and control systems. Overall, mechanical engineering offers a diverse range of career opportunities, combining creativity, analytical skills, and technical expertise to tackle real-world challenges and drive innovation.",
        "fees": "TBD (To Be Disclosed)",
        "duration": "2 Years",
        "eligibility_criteria": {
            "eligibility": "Candidates must have a Bachelor's degree in Mechanical Engineering or a related field with at least 50% marks (45% for reserved category) in aggregate from a recognized university."
        },
        "affiliation": {
            "affiliated_to": "IKGPTU, Jalandhar",
            "approved_by": "AICTE"
        },
        "mode_of_admission": "Admission for 85% of seats for residents of Punjab and 15% of seats for outsiders shall be made strictly on the basis of valid GATE score.",
        "program_highlights": [
            "Design, Analysis, and Manufacturing: Focus on the entire lifecycle of mechanical systems.",
            "Application of Physics and Materials Science: Utilize principles to improve machinery and devices.",
            "Diverse Industry Opportunities: Work in automotive, aerospace, energy, manufacturing, robotics, and more.",
            "Computer-Aided Design (CAD) and Simulation Tools: Use technology to create virtual models and perform analysis.",
            "Collaborative Work: Coordinate with other engineers for smooth integration of mechanical systems.",
            "Real-World Challenges: Tackle complex problems and drive innovation in various sectors."
        ],
        "labs": [
            {
                "title": "Mechanical Design Lab",
                "description": "Design and analyze mechanical components and systems.",
                "image": "https://img.freepik.com/free-photo/close-up-cropped-shot-professional-afro-american-mechanic-checking-tire-pressure-wheel-blower-gun-filling-air-nozzle-car-service-station-auto-repair-maintenance-shop_295783-2724.jpg"
            },
            {
                "title": "Thermal Engineering Lab",
                "description": "Study thermodynamics, heat transfer, and fluid mechanics.",
                "image": "https://img.freepik.com/free-photo/close-up-water-turbine-system-turbine-generator-construction-power-plant_295783-3224.jpg"
            },
            {
                "title": "Manufacturing Processes Lab",
                "description": "Learn about manufacturing techniques and processes.",
                "image": "https://img.freepik.com/free-photo/young-engineer-working-3d-printer_1150-21417.jpg"
            }
        ]
    }
]
