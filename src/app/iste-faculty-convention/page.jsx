...
const Page = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.institution.trim()) {
      newErrors.institution = 'Institute is required';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://sheetdb.io/api/v1/0v8ojsce331c7', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-50 via-white to-emerald-50 flex items-center justify-center p-4 py-12">
      {showSuccess && (
        <div className="fixed top-8 right-8 z-50 animate-in slide-in-from-right duration-500">
          <div className="bg-white border-l-4 border-green-500 rounded-2xl p-6 shadow-2xl max-w-md backdrop-blur-sm">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-base leading-relaxed">
                  Thank you for registering. We look forward to seeing you at the ceremony.
                </p>
              </div>
              <button
      ...
      <div className="w-full max-w-5xl">
        <div className="text-center mb-16">
          <div className="flex justify-center mb-8">
            <div className="w-28 h-28 bg-gradient-to-br from-[#1b9b7c] to-[#168a6f] rounded-3xl flex items-center justify-center shadow-2xl transform hover:scale-105 transition-transform duration-300">
              <img
          ...
          <p className="text-gray-600 text-xl max-w-2xl mx-auto leading-relaxed">
            Join us for the prestigious ISTE Faculty Inauguration Ceremony. 
            Please complete the registration form below.
          </p>
        </div>

        <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
          <div className="bg-gradient-to-r from-[#1b9b7c] to-[#168a6f] p-8">
          ...
          <div className="p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
              <div className="space-y-3">
                <label htmlFor="fullName" className="block text-base font-bold text-gray-700 uppercase tracking-wider">
                  Full Name *
                </label>
                <input
                  type="text"
                  ...
                  className={`w-full px-6 py-5 text-lg border-2 rounded-2xl focus:outline-none focus:ring-4 focus:ring-[#1b9b7c] focus:ring-opacity-30 focus:border-[#1b9b7c] transition-all duration-200 ${
                    errors.fullName ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-gray-400 bg-gray-50'
                  }`}
                  placeholder="Enter your full name"
                />
                {errors.fullName && (
                  <p className="text-red-600 text-base font-semibold flex items-center">
                    <span className="mr-2">⚠</span> {errors.fullName}
                  </p>
                )}
              </div>

              <div className="space-y-3">
                <label htmlFor="email" className="block text-base font-bold text-gray-700 uppercase tracking-wider">
                  Email Address *
                </label>
                <input
                  type="email"
                  ...
                  onChange={handleChange}
                  className={`w-full px-6 py-5 text-lg border-2 rounded-2xl focus:outline-none focus:ring-4 focus:ring-[#1b9b7c] focus:ring-opacity-30 focus:border-[#1b9b7c] transition-all duration-200 ${
                    errors.email ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-gray-400 bg-gray-50'
                  }`}
                  placeholder="Enter your email address"
                />
                {errors.email && (
                  <p className="text-red-600 text-base font-semibold flex items-center">
                    <span className="mr-2">⚠</span> {errors.email}
                  </p>
                )}
              </div>

              <div className="space-y-3">
                <label htmlFor="phoneNumber" className="block text-base font-bold text-gray-700 uppercase tracking-wider">
                  Phone Number *
                </label>
                <input
                  type="tel"
                  ...
                  onChange={handleChange}
                  className={`w-full px-6 py-5 text-lg border-2 rounded-2xl focus:outline-none focus:ring-4 focus:ring-[#1b9b7c] focus:ring-opacity-30 focus:border-[#1b9b7c] transition-all duration-200 ${
                    errors.phoneNumber ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-gray-400 bg-gray-50'
                  }`}
                  placeholder="Enter 10-digit phone number"
                />
                {errors.phoneNumber && (
                  <p className="text-red-600 text-base font-semibold flex items-center">
                    <span className="mr-2">⚠</span> {errors.phoneNumber}
                  </p>
                )}
              </div>

              <div className="space-y-3">
                <label htmlFor="institution" className="block text-base font-bold text-gray-700 uppercase tracking-wider">
                  Institute *
                </label>
                <input
                  type="text"
                  ...
                  onChange={handleChange}
                  className={`w-full px-6 py-5 text-lg border-2 rounded-2xl focus:outline-none focus:ring-4 focus:ring-[#1b9b7c] focus:ring-opacity-30 focus:border-[#1b9b7c] transition-all duration-200 ${
                    errors.institution ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-gray-400 bg-gray-50'
                  }`}
                  placeholder="Enter your institute name"
                />
                {errors.institution && (
                  <p className="text-red-600 text-base font-semibold flex items-center">
                    <span className="mr-2">⚠</span> {errors.institution}
                  </p>
                )}
              </div>

              <div className="md:col-span-2 space-y-3">
                <label htmlFor="designation" className="block text-base font-bold text-gray-700 uppercase tracking-wider">
                  Designation *
                </label>
                <input
                  type="text"
                  ...
                  onChange={handleChange}
                  className={`w-full px-6 py-5 text-lg border-2 rounded-2xl focus:outline-none focus:ring-4 focus:ring-[#1b9b7c] focus:ring-opacity-30 focus:border-[#1b9b7c] transition-all duration-200 ${
                    errors.designation ? 'border-red-500 bg-red-50' : 'border-gray-300 hover:border-gray-400 bg-gray-50'
                  }`}
                  placeholder="e.g., Professor, Associate Professor, Assistant Professor"
                />
                {errors.designation && (
                  <p className="text-red-600 text-base font-semibold flex items-center">
                    <span className="mr-2">⚠</span> {errors.designation}
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="flex justify-center mt-12">
              <button
                ...
                disabled={isSubmitting}
                className="bg-gradient-to-r from-[#1b9b7c] to-[#168a6f] hover:from-[#168a6f] hover:to-[#1b9b7c] disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed text-white font-bold py-5 px-16 rounded-2xl transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-[#1b9b7c] focus:ring-opacity-50 text-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 active:translate-y-0"
              >
                {isSubmitting ? (
